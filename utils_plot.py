...
#conv random Grp13
filenames_meta_13 = '/Users/pangda/predicting_generalization/automl/data/Grp13_conv_random/mdl_conv_random_mdl_{}/meta_data.yml'
filenames_other_13 = '/Users/pangda/predicting_generalization/automl/data/Grp13_conv_random/mdl_conv_random_mdl_{}/other_data.yml'
files_nb_13 = 186

train_errors_13 = get_train_errors(filenames_meta_13,files_nb_13)
test_errors_13 = get_test_errors(filenames_meta_13, files_nb_13)
min_train_errors_13 = get_min_train_errors(filenames_other_13, files_nb_13)
min_test_errors_13 = get_min_test_errors(filenames_other_13, files_nb_13)
differences_13 = get_difference(test_errors_13,train_errors_13)
differences_of_min_13 = get_difference(min_test_errors_13,min_train_errors_13)
...
#
to_plot = [train_errors_13,test_errors_13,min_train_errors_13,min_test_errors_13,differences_13,differences_of_min_13]
to_plot_name = ['train_errors_cov_random','test_errors_cov_random','min_train_errors_cov_random','min_test_errors_cov_random','differences_cov_random','differences_of_min_cov_random']
#Grp4,5,7,8 11  are tower one.
